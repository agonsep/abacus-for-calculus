        ...
        >
          ...
          >
            ...
            <div className="space-y-3 text-sm leading-relaxed text-foreground/90">
              <p>
                Move the red stones so they form a second curve in the empty space above the orange stones. This move is a foundational move in calculus. It represents the operation of going from a curve with any number of variable quantities to a curve based on small differences. One can use the abacus to make robust estimates of the slope of a tangent or the area under a curve, for an unlimited number of curves. Details about the math are below.
              </p>
              <p>
