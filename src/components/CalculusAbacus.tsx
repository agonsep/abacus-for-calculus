        ...
        >
          ...
          >
            ...
            <div className="space-y-3 text-sm leading-relaxed text-foreground/90">
              ...
              <p>
                The <span className="text-[#ff932a]">orange stones</span> (or size-stones) represent values of <span className="font-mono text-primary">y</span> along a curve. The <span className="text-[#e8352c]">red stones</span> (or change-size-stones) represent the differences between neighboring columns of orange stones. Experiment by inputting succesively smaller increments. Does the slope estimate approach a limit as the increment approaches zero? What would happen if the increment were infinitely small?
              </p>
